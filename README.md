...
| :----------------------------: | :---------------------: |
| ![Profile](cake-planner-frontend/docs/img/profile_en.png) | ![2FA](cake-planner-frontend/docs/img/2fa_de.png)  |
...
| user management                       |
| ------------------------------------- |
| ![Profile](cake-planner-frontend/docs/img/admin-usermgmt_en.png) |
